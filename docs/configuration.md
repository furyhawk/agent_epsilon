...
|----------|---------|-------------|
| `PROJECT_NAME` | `agent_epsilon` | Display name for the project |
...
| `POSTGRES_DB` | `agent_epsilon` | Database name |
...
| `LOGFIRE_SERVICE_NAME` | `agent_epsilon` | Service name in Logfire dashboard |
